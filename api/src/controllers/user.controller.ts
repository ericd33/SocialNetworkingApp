...
type ReqWemail = Request & { currentUserEmail: string | undefined }

export const myUser = async (req: ReqWemail, res: Response) => {


  const user = await userSchema.findOne({ "email": req.currentUserEmail });
